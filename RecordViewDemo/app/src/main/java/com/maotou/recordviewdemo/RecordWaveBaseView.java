        ...
        public void run() {
            ...
            while (mIsDraw) {
                ...
                if (mBackCanVans != null) {
                    ...
                    try {
                        //画横线
                        mBackCanVans.drawLine(startMargin, topMargin, width - endMargin, topMargin, mScalePaint);
                        ...
                        for (int i = 0; i < drawList.size(); i++) {
                            ...
                            //画下波纹
                            mBackCanVans.drawLine(startMargin + i * mScaleMargin, mMiddleLineHeight + drawList.get(i).get(KEY_VOLUME) + mMin, startMargin + i * mScaleMargin, mMiddleLineHeight + mMin, mGrainPaint);
                            //画上波纹
                            mBackCanVans.drawLine(startMargin + i * mScaleMargin, mMiddleLineHeight - drawList.get(i).get(KEY_VOLUME) - mMin, startMargin + i * mScaleMargin, mMiddleLineHeight - mMin, mGrainPaint);

                            //画标记
                            if (dotList.contains(i)) {
                                mBackCanVans.drawCircle(startMargin + i * mScaleMargin, topMargin, markR, mDotPaint);
                            }
                        }
                        ...
                        mBackCanVans.drawCircle(x, mRectHeight - endMargin, r, mDotPaint);
                    } catch (Exception e) {
                        e.printStackTrace();
                        continue;
                    }
