 ...
 */
public class RecordWaveBaseTextureView extends TextureView {
  ...
  public RecordWaveBaseTextureView(Context context) {
    super(context);
...
/*    public void setInt(int l){
  ...
  public RecordWaveBaseTextureView(Context context, AttributeSet attrs) {
    super(context, attrs);
    this.context = context;
    init(context);
  }

  public RecordWaveBaseTextureView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void run() {
      ...
      while (mIsDraw) {
        ...
        if (mBackCanVans != null) {
          mBackCanVans.drawColor(Color.BLUE, PorterDuff.Mode.CLEAR);
          mBackCanVans.drawColor(Color.BLUE);
          int memory = 0;
          if (drawList.size() != 0) {
  ...
  Handler handler = new Handler() {
    ...
    public void handleMessage(Message msg) {
      RecordWaveBaseTextureView.this.invalidate();
    }
  };
