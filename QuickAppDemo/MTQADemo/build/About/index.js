...
/***/ function(module, exports) {
	...
	exports.default = {
	  ...
	  onReady: function onReady() {
	    ...
	    console.debug("触发:onReady");
	    console.debug("执行:获取模板节点:${this.$rootElement()}");
	  },
	  onShow: function onShow() {
	    this.lcList.push('onShow');
	    console.debug("触发:onShow");
	    console.debug('执行:获取页面显示状态属性:${this.$visible}');
	  },
	  onHide: function onHide() {
	    this.lcList.push('onHide');
	
	    console.debug('触发:onHide');
	    console.debug('执行:获取页面显示状态属性:${this.$visible}');
	  },
