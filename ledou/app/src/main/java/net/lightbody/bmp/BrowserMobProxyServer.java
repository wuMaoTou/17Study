...
/**
 * A LittleProxy-based implementation of {@link BrowserMobProxy}.
 */
public class BrowserMobProxyServer implements BrowserMobProxy {
     ...
     * {@link AdvancedHostResolver}. It allows the resolvers to be changed on-the-fly without re-bootstrapping the
     * littleproxy server. The default resolver (native JDK resolver) can be changed using {@link #setHostNameResolver(AdvancedHostResolver)} and
