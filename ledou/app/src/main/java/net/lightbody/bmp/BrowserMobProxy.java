...
public interface BrowserMobProxy {
     ...
     * additional {@link CaptureType} data types. {@link CaptureType} provides several
     ...
     * @throws IllegalStateException if HAR capture has not been enabled via {@link #newHar()} or {@link #newHar(String)}
     */
    Har newPage();
     ...
     * @throws IllegalStateException if the whitelist is not enabled
     */
     ...
     * @throws IllegalStateException if the proxy is already started
     */
